...
<link href="styles/offer_lift.css" rel="stylesheet">
...
//Insert Query of SQL
  $get_Query = "insert into add_offer(name, source, destination, date, email, contact, age, address, vehicle, Photo) values ('$name','$source','$destination', '$date', '$email', $contact, $age, '$address', '$vehicle', '$Photo')";
...
<form action="offer_lift.php" method="post"  enctype="multipart/form-data" >
      ...
      while($row=mysqli_fetch_array($res))
        {
            ...
            echo "<option value='".$row[0]."'>".$row[0]."</option>";
              ...
              echo"</select>";
			  ?>
<label>Type of Vehicle you have:</label>
...
<input class="input" name="date" type="date" value="">
 <input class="submit1" name="submit" type="submit" value="Offer lift" style="background-color:#00F;padding:2px">
</form>
</div>
</div>
