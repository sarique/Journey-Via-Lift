...
<link rel="stylesheet" href="styles/styles_review.css" media="all" />
</head>

<body>
<div class="main_wrapper">
 <div id="navbar">
 <img src="images/jvl4.jpg" style="float:left" width='150' height='100' >
<li><a href="how_jvl_help.php" style="float:left;margin-left:200px; margin-top:30px; color:#06F;font-size:20px">Why journey via lift??</a></li>
  ...
  <?php
	   ...
	   ?>
       <div id="form">
<form method="post" action="write_review1.php" enctype="multipart/form-data">
